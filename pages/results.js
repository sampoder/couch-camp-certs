...
let juniorTeamChallengeScoresProcessed = orderBy(
  ...
  .map(({ Points, TeamID }, index) => ({
    ...
    rank: index + 1,
    members:
      juniorNames[TeamID]["member1"] +
      ", " +
      juniorNames[TeamID]["member2"] +
      ", " +
      juniorNames[TeamID]["member3"],
  }));
...
const Home = (props) => (
  <>
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Team Challenge</strong>
        </p>
        <Table data={juniorTeamChallengeScoresProcessed}>
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Team Challenge</strong>
        </p>
        <Table data={seniorTeamChallengeScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Team Writing</strong>
        </p>
        <Table data={juniorTeamWritingScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Team Writing</strong>
        </p>
        <Table data={seniorTeamWritingScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Team Debate</strong>
        </p>
        <Table data={juniorTeamDebateScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Team Debate</strong>
        </p>
        <Table data={seniorTeamDebateScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Team Bowl</strong>
        </p>
        <Table data={juniorTeamBowlScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Scholar Writing</strong>
        </p>
        <Table data={juniorScholarWritingScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Scholar Writing</strong>
        </p>
        <Table data={seniorScholarWritingScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Scholar Debate</strong>
        </p>
        <Table data={juniorScholarDebateScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Scholar Debate</strong>
        </p>
        <Table data={seniorScholarDebateScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Scholar Challenge</strong>
        </p>
        <Table data={juniorScholarChallengeScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Scholar Challenge</strong>
        </p>
        <Table data={seniorScholarChallengeScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Scholar Overall</strong>
        </p>
        <Table data={juniorScholarOverallScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Scholar Overall</strong>
        </p>
        <Table data={seniorScholarOverallScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Scholar ID" />
          <Table.Column prop="name" label="Name" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Junior Team Overall</strong>
        </p>
        <Table data={juniorTeamOverallScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
    ...
    <Grid.Container gap={2} justify="center">
      <Grid xs={23} md={18} style={{ textAlign: "left" }}>
        <p>
          <strong>Senior Team Overall</strong>
        </p>
        <Table data={seniorTeamOverallScoresProcessed}>
          <Table.Column prop="rank" label="Rank" />
          <Table.Column prop="id" label="Team ID" />
          <Table.Column prop="members" label="Team Members" />
          <Table.Column prop="points" label="Points" />
